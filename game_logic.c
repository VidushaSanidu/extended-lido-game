...
const int BASE_POSITIONS[PLAYERS] = {0, 13, 26, 39}; // Starting positions for R, G, Y, B
const int APPROACH_POSITIONS[PLAYERS] = {50, 11, 24, 37}; // Last cell before home straight for R, G, Y, B
const int HOME_ENTRY[PLAYERS] = {51, 12, 25, 38}; // First position in the home straight for R, G, Y, B
